...
graph TD
    ...
    subgraph Process1["⚙️ Process 1 — server.js (HTTP Server)"]
        MW["🛡️ Global Middleware<br/>Helmet · CORS · Morgan · JSON Parser"]
        Router["🗺️ Express Router<br/>/auth · /users · /bookings<br/>/organizations · /analytics · /notifications"]
        ...
        Model["🗄️ Model Layer<br/>Parameterised SQL Queries"]
    end
