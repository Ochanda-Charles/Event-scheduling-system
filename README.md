...
sequenceDiagram
 ...
 DB-->>Handler: notification created 
...
sequenceDiagram
 ...
 Worker->>Worker: emit 'completed' event 
...
sequenceDiagram
 ...
 Server->>DB: INSERT INTO organization_members<br/>(organization_id, user_id, role)<br/>ON CONFLICT → null (already member check)
...
sequenceDiagram
 ...
 Note over Handler,DB: Sequential — 2× the time
